  ...
  <section class="mx-auto max-w-[78ch] px-5 py-10">
    ...
    <section class="js-faq-group mb-8" aria-labelledby="g-conf">
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          ...
          <p class="m-0">Three days covers the competition results with the score sheets on the tables, a public review of the six category standards, the member organisation floor, the hands-on sessions that do not work over video, and the governance &mdash; the annual election and the committee reports.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          ...
          <p class="m-0">Creamery and Retailer memberships can register their covered staff under the one membership, which is the part organisations most often miss until after the deadline.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        <summary class="font-display cursor-pointer text-lg font-bold tracking-tight">Can non-members attend?</summary>
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">Yes. Sessions, the organisation floor and the evening events are open to anyone who registers.</p>
    ...
    <section class="js-faq-group mb-8" aria-labelledby="g-year">
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">Yes and yes. Regional meetups are organised by members for members, most of them informal, most of them free or close to it: a tasting, a creamery tour, a roundtable on whatever is biting locally that season.</p>
          <p class="m-0">They are open to any member regardless of where you are based, and a member travelling is usually the most interesting person in the room. Dates are on the <a href="<?php echo esc_url( home_url( '/events/' ) ); ?>" class="text-brick underline underline-offset-2">events page</a>; to start one where there is nothing, write to <a href="mailto:events@morecheese.org" class="text-brick underline underline-offset-2">events@morecheese.org</a> and they will find you the other members nearby.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        <summary class="font-display cursor-pointer text-lg font-bold tracking-tight">Which events count towards continuing education?</summary>
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">Most Federation sessions carry credit towards reconfirming the Certified Cheese Professional credential, and the event listing says so on each entry. The hands-on workshops and the technical sessions carry the most.</p>
          <p class="m-0">Social meetups and the organisation floor do not, which surprises nobody. If you are working towards a reconfirmation date, the Annual Conference on its own will usually get you most of the way.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
