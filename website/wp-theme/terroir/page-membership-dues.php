    ...
    <section class="js-faq-group mb-8" aria-labelledby="g-cost">
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          ...
          <p class="m-0">Every tier carries the same vote, the same weekly brief, the same archive and the same discount on credential exams. What changes between tiers is how many people at your organisation the membership covers and which extras come with it. The full rate card is on the <a href="<?php echo esc_url( home_url( '/join/' ) ); ?>" class="text-brick underline underline-offset-2">Join page</a>.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        <summary class="font-display cursor-pointer text-lg font-bold tracking-tight">Which tier am I?</summary>
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">The tier follows what your organisation does, not how big it is. <b>Creamery</b> if you make cheese, from a two-vat farmstead to a regional plant. <b>Retailer</b> if you sell it, at a counter or into wholesale. <b>Affiliate</b> if you supply the trade &mdash; suppliers, laboratories, distributors, consultants. <b>Individual</b> if the membership is yours rather than an employer&rsquo;s.</p>
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          ...
          <p class="m-0">It carries the same credential discount as every other tier, which is the part that matters if you are working up the ladder. Education Programmes also holds a small number of course places each year for members in their first two years in the trade; ask, because they are not advertised.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">No. A <b>Creamery</b> membership covers up to six staff and a <b>Retailer</b> membership up to four, under the one payment. Each covered person gets their own account, their own copy of the brief and their own member rate on courses and events. The organisation gets one vote.</p>
