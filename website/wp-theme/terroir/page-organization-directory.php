...
<main id="main">
  ...
  <section class="border-b border-charcoal/15 bg-milk">
    <div class="mx-auto max-w-6xl px-5 py-12 md:px-10 md:py-14">
      ...
      <p class="m-0 max-w-[58ch] text-[17px] text-[#3A403C]">How the organization directory works, what it shows about you, and which inbox answers which question fastest.</p>
    </div>
  </section>
  ...
  <section class="mx-auto max-w-[78ch] px-5 py-10">
    ...
    <section class="js-faq-group mb-8" aria-labelledby="g-dir">
      <h2 id="g-dir" class="font-display m-0 mb-4 text-[26px] font-extrabold tracking-tight text-pasture">The organization directory</h2>
      <div class="space-y-3">
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        <summary class="font-display cursor-pointer text-lg font-bold tracking-tight">What is the organization directory?</summary>
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">A searchable listing of all 641 member organizations across 41 countries &mdash; creameries, shops, wholesale buyers, laboratories, distributors and suppliers &mdash; filterable by what an organization does and where it is.</p>
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">To other members: your name and role, your organization, the city and country you work in, a professional contact address, any credentials you hold and the year you joined.</p>
          <p class="m-0">Never shown, to anyone: home address, personal contact details, what you pay, your course and exam records, and anything in your correspondence with staff. Non-members see organizations, not individuals.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        <summary class="font-display cursor-pointer text-lg font-bold tracking-tight">Can I opt out, or list less?</summary>
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">Both. You can leave the directory entirely, or stay listed with less &mdash; the organization and what it does, without the contact detail.</p>
          <p class="m-0">It is worth being honest about the trade-off: a member who is listed but unreachable gets fewer useful inquiries and the same amount of nothing else. Ask <a href="mailto:memberservices@morecheese.org" class="text-brick underline underline-offset-2">memberservices@morecheese.org</a> for either.</p>
        </div>
      </details>
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">No. The directory is for professional contact, one inquiry at a time. Bulk export, scraping and using it to build a marketing list all breach the terms every member agrees to, and they are the most reliable way to lose a membership.</p>
          <p class="m-0">If you want to reach the membership, there are three proper routes: sponsor an event, take space in the publications, or take part in the organization floor at the conference. The <a href="<?php echo esc_url( home_url( '/faq/publications-resources/' ) ); ?>" class="text-brick underline underline-offset-2">publications page</a> has the detail.</p>
        </div>
      </details>
      </div>
    </section>
    ...
    <section class="js-faq-group mb-8" aria-labelledby="g-who">
      ...
      <details class="js-faq-item rounded-2xl border-[1.5px] border-charcoal bg-milk p-5">
        ...
        <div class="mt-3 text-[15px] text-[#3A403C]">
          <p class="m-0 mb-2">Five roles carry the day-to-day work: Executive Director, Membership Operations, Communications, Education Programs and Events. They are listed by role on the <a href="<?php echo esc_url( home_url( '/about/' ) ); ?>" class="text-brick underline underline-offset-2">about page</a> rather than by name, because this is a demonstration site and inventing people to fill them would help nobody.</p>
