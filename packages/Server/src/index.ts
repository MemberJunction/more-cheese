 ...
 * function named by "startupExport" (LoadMoreCheeseDemoServer below). That call —
 ...
 */
import { LoadMoreCheeseDemoEntitiesServer } from '@mj-more-cheese-demo/core-entities-server';
import { LoadMoreCheeseDemoActions } from '@mj-more-cheese-demo/actions';
...
export function LoadMoreCheeseDemoServer(): void {
    ...
    LoadMoreCheeseDemoEntitiesServer();
    LoadMoreCheeseDemoActions();
}
