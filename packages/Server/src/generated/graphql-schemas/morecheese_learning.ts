...
import { morecheeselearningCertificationEntity, morecheeselearningCourseEnrollmentEntity, morecheeselearningCourseEntity, morecheeselearningMemberCertificationEntity } from '@mj-biz-apps/more-cheese-entities';
...
export class morecheeselearningCertification_ {
    ...
    @Field({nullable: true, description: `Business key (e.g. CERT-CCP)`}) 
    @MaxLength(50)
    CertKey?: string;
    ...
    @Field(() => Int, {nullable: true, description: `Years the credential stays valid after award`}) 
    ValidYears?: number;
...
export class morecheeselearningCourseEnrollment_ {
    ...
    @Field({nullable: true, description: `Business key; UUIDs derive from it`}) 
    @MaxLength(80)
    EnrollKey?: string;
    ...
    @Field({nullable: true, description: `Enrollment date — always inside a valid membership window`}) 
    EnrolledOn?: Date;
        
    @Field({nullable: true, description: `InProgress, Completed, or Dropped (completion is a calibrated outcome)`}) 
    @MaxLength(50)
    Status?: string;
...
export class morecheeselearningCourse_ {
    ...
    @Field({nullable: true, description: `Cohort start date`}) 
    StartDate?: Date;
        
    @Field(() => Int, {nullable: true, description: `Course length in weeks`}) 
...
export class morecheeselearningMemberCertification_ {
    ...
    @Field({nullable: true, description: `InProgress, Awarded, Expired, or Withdrawn`}) 
    @MaxLength(50)
    Status?: string;
