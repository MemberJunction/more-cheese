...
import { morecheeseeventsCompetitionEntryEntity, morecheeseeventsEventRegistrationEntity, morecheeseeventsEventEntity } from '@mj-biz-apps/more-cheese-entities';
...
export class morecheeseeventsEventRegistration_ {
    ...
    @Field({nullable: true, description: `Business key: REG-<member>-<event>[-n]; UUIDs derive from it`}) 
    @MaxLength(120)
    RegKey?: string;
    ...
    @Field({nullable: true, description: `Registration date — always inside a valid membership window by construction`}) 
    RegisteredOn?: Date;
...
export class morecheeseeventsEvent_ {
    ...
    @Field({nullable: true, description: `Business key (e.g. EVT-2025-CONF); UUIDs derive from it`}) 
    @MaxLength(50)
    EventKey?: string;
        
    @Field({nullable: true, description: `Event display name`}) 
    @MaxLength(200)
    Name?: string;
        
    @Field({nullable: true, description: `Conference, Workshop, or Webinar`}) 
    @MaxLength(50)
    EventType?: string;
        
    @Field({nullable: true, description: `Date the event takes place`}) 
    EventDate?: Date;
        
    @Field(() => Boolean, {nullable: true, description: `Virtual events have no venue coordinates (COVID-era conferences were virtual)`}) 
    IsVirtual?: boolean;
        
    @Field(() => Boolean, {nullable: true, description: `Whether registration is billable (webinars are free)`}) 
    IsPaid?: boolean;
