/**
 * @mj-more-cheese-demo/core-entities-server — SERVER-ONLY entity subclasses
 ...
 * (@mj-more-cheese-demo/entities) is a HARD dependency pinned to the exact same
 ...
 *
 *   @RegisterClass(BaseEntity, 'MoreCheese: Sample Records')
