...
import { morecheeseeventsEventRegistrationEntity } from '@mj-biz-apps/more-cheese-entities';
...
export class morecheeseeventsEventRegistrationFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'eventParticipation', sectionName: 'Event Participation', isExpanded: true },
