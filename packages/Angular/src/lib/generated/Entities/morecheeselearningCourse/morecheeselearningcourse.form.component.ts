...
import { morecheeselearningCourseEntity } from '@mj-biz-apps/more-cheese-entities';
...
export class morecheeselearningCourseFormComponent extends BaseFormComponent {
    ...
    override async ngOnInit() {
        ...
        this.initSections([
            ...
            { sectionKey: 'timelineAndConfiguration', sectionName: 'Timeline and Configuration', isExpanded: true },
