...
| [`packages/CoreEntitiesServer`](packages/CoreEntitiesServer) | `@mj-biz-apps/more-cheese-core-entities-server` | Server-side entity overrides, business logic validation, and database save pipelines. |
| [`packages/Actions`](packages/Actions) | `@mj-biz-apps/more-cheese-actions` | Deterministic MemberJunction Actions invokable by workflows, agents, and APIs. |
