...
| **Build** | `npx turbo build --filter="@mj-more-cheese-demo/*"` (or `npm run build:packages` standalone) | — |
...
Everything above in depth: [docs/template-docs/README.md](docs/template-docs/README.md). The complete
