...
| **MoreCheese (ours)** | `morecheese_members/_events/_learning/_orders` | `MoreCheese: ` | 15 tables | MemberProfile + OrganizationProfile (the extension rows carrying everything upstream doesn't model), MembershipPeriod, events, learning, money |
